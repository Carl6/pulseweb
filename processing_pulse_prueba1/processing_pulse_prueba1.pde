...
void setup() {
  ...
  frameRate(30);
  font = loadFont("HelveticaNeue-Bold-25.vlw");
  textFont(font);
  textAlign(CENTER);
  rectMode(CENTER);
  ellipseMode(CENTER);
...
// PRINT THE DATA AND VARIABLE VALUES
 ...
 // text("Pulse Sensor Amped Visualizer v1.5",245,30);    // tell them what you are
  ...
  textSize(45);
  text(BPM + " BPM",550,100);                           // print the Beats Per Minute
...
void drawPulseWaveform(){
  ...
  //  if ((x % 3)==0){
  //  float noiseVal = noise((BPM+x)*noiseScale, random(0.02,4)*noiseScale);
  //  stroke(noiseVal*255);
  //  stroke(52,205,222);
  //  line(x, 100+noiseVal*250, 350, height-30);}
